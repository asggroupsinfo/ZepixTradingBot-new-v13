...
class MenuCallbackHandler:
    ...
    def _handle_view_logic_settings(self, user_id: int, message_id: int):
        ...
        for logic_name in ["LOGIC1", "LOGIC2", "LOGIC3"]:
    ...
    def _handle_tf_configure_menu(self, user_id: int, message_id: int):
        ...
        l1 = config.get("LOGIC1", {})
        l2 = config.get("LOGIC2", {})
        l3 = config.get("LOGIC3", {})
        
        keyboard = {
            "inline_keyboard": [
                [{"text": f"🔧 LOGIC1 (5m) - Lot: {l1.get('lot_multiplier', 1.0)}x, SL: {l1.get('sl_multiplier', 1.0)}x", 
                  "callback_data": "tf_config_logic1"}],
                [{"text": f"🔧 LOGIC2 (15m) - Lot: {l2.get('lot_multiplier', 1.0)}x, SL: {l2.get('sl_multiplier', 1.0)}x", 
                  "callback_data": "tf_config_logic2"}],
                [{"text": f"🔧 LOGIC3 (1h) - Lot: {l3.get('lot_multiplier', 1.0)}x, SL: {l3.get('sl_multiplier', 1.0)}x", 
                  "callback_data": "tf_config_logic3"}],
        ...
        text = (
            ...
            f"LOGIC1: {l1.get('lot_multiplier', 1.0)}x lot, {l1.get('sl_multiplier', 1.0)}x SL\n"
            f"LOGIC2: {l2.get('lot_multiplier', 1.0)}x lot, {l2.get('sl_multiplier', 1.0)}x SL\n"
            f"LOGIC3: {l3.get('lot_multiplier', 1.0)}x lot, {l3.get('sl_multiplier', 1.0)}x SL"
        )
    ...
    def _handle_tf_adjustment_menu(self, user_id: int, message_id: int, logic_name: str, param_type: str):
        ...
        buttons.append([{"text": "🔙 Back", "callback_data": f"tf_config_{logic_name.lower()}"}])
    ...
    def _handle_tf_help_content(self, user_id: int, message_id: int, help_type: str):
        ...
        if help_type == "what":
            text = (
                ...
                "• <b>LOGIC1 (5m)</b>: Fast moves\n"
                "  Aggressive, 1.25x lot, tight SL\n\n"
                "• <b>LOGIC2 (15m)</b>: Balanced\n"
                "  Standard lot, 1.5x SL\n\n"
                "• <b>LOGIC3 (1h)</b>: Slow moves\n"
    ...
    def _handle_tf_example_scenario(self, user_id: int, message_id: int, scenario: str):
        ...
        if scenario == "conservative":
            text = (
                ...
                "• LOGIC1 (5m): Lot 0.75x, SL 1.5x, Window 45m\n"
                "• LOGIC2 (15m): Lot 0.625x, SL 2.0x, Window 60m\n"
                "• LOGIC3 (1h): Lot 0.5x, SL 3.0x, Window 180m\n\n"
                "<b>Why This Works:</b>\n"
            ...
            text = (
                ...
                "<b>Recommended Settings:</b>\n"
                "• LOGIC1 (5m): Lot 1.25x, SL 1.0x, Window 30m\n"
                "• LOGIC2 (15m): Lot 1.0x, SL 1.5x, Window 45m\n"
                "• LOGIC3 (1h): Lot 0.625x, SL 2.5x, Window 120m\n\n"
                "<b>Why This Works:</b>\n"
            ...
            text = (
                ...
                "<b>Recommended Settings:</b>\n"
                "• LOGIC1 (5m): Lot 1.5x, SL 0.75x, Window 15m\n"
                "• LOGIC2 (15m): Lot 1.25x, SL 1.0x, Window 30m\n"
                "• LOGIC3 (1h): Lot 1.0x, SL 1.5x, Window 60m\n\n"
                "<b>Why This Works:</b>\n"
            ...
            text = (
                ...
                "<b>Recommended Settings:</b>\n"
                "• LOGIC1 (5m): Lot 1.5x, SL 0.75x, Window 20m\n"
                "• LOGIC2 (15m): Lot 0.5x, SL 1.0x, Window 30m\n"
                "• LOGIC3 (1h): Lot 0.25x, SL 1.0x, Window 60m\n\n"
                "<b>Strategy Explanation:</b>\n"
                "1. Focus on LOGIC1 (5m) signals\n"
                "2. Use tight SL for quick exits\n"
                "3. Bigger lot size on 5m only\n"
                "4. Reduce LOGIC2/3 to minimum\n\n"
                "<b>Advanced Tips:</b>\n"
            ...
            text = (
                ...
                "<b>Recommended Settings:</b>\n"
                "• LOGIC1 (5m): Lot 0.5x, SL 1.0x, Window 60m\n"
                "• LOGIC2 (15m): Lot 0.75x, SL 1.5x, Window 90m\n"
                "• LOGIC3 (1h): Lot 1.0x, SL 3.0x, Window 180m\n\n"
                "<b>Strategy Explanation:</b>\n"
                "1. Focus on LOGIC3 (1h) signals\n"
