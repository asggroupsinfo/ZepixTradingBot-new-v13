...
class SessionManager:
    ...
    def create_session(self, symbol: str, direction: str, signal: str, logic: str = "LOGIC1") -> str:
        """
        ...
        Args:
            ...
            logic: Trading logic type (LOGIC1, LOGIC2, LOGIC3) - Phase 6 tracking
    ...
    def update_logic_stats(self, trade):
        ...
        try:
            ...
            logic_type = getattr(trade, 'logic_type', getattr(trade, 'strategy', 'LOGIC1'))
