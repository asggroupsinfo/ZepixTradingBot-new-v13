def show_tf_configure_menu(self, user_id: int, message_id: int):
    ...
    keyboard = {
        "inline_keyboard": [
            ...
            [{"text": f"🔧 LOGIC2 (15m) - Lot: {l2.get('lot_multiplier', 1.0)}x, SL: {l1.get('sl_multiplier', 1.0)}x", 
    ...
    text = (
        ...
        f"LOGIC1: {l1.get('lot_multiplier', 1.0)}x lot, {l1.get('sl_multiplier', 1.0)}x SL, {l1.get('recovery_window_minutes', 30)}m window\n"
        f"LOGIC2: {l2.get('lot_multiplier', 1.0)}x lot, {l2.get('sl_multiplier', 1.0)}x SL, {l2.get('recovery_window_minutes', 45)}m window\n"
        f"LOGIC3: {l3.get('lot_multiplier', 1.0)}x lot, {l3.get('sl_multiplier', 1.0)}x SL, {l3.get('recovery_window_minutes', 120)}m window"
    )
...
def show_tf_help_content(self, user_id: int, message_id: int, help_type: str):
    ...
    if help_type == "what":
        text = (
            ...
            "<b>Three Logics:</b>\n"
            "• <b>LOGIC1 (5m)</b>: Aggressive, 1.25x lot, 1.0x SL\n"
            "• <b>LOGIC2 (15m)</b>: Balanced, 1.0x lot, 1.5x SL\n"
            "• <b>LOGIC3 (1h)</b>: Conservative, 0.625x lot, 2.5x SL\n\n"
            "<b>Key Benefit:</b>\n"
        ...
        text = (
            ...
            "• Base: 0.04 lots\n"
            "• LOGIC1 (1.25x): 0.04 × 1.25 = 0.05 lots\n"
            "• LOGIC2 (1.0x): 0.04 × 1.0 = 0.04 lots\n"
            "• LOGIC3 (0.625x): 0.04 × 0.625 = 0.025 lots\n\n"
            "<b>SL Multiplier:</b>\n"
            "Base SL distance × Multiplier = Final SL\n\n"
            "Example (EURUSD, SL-1 = 100 pips base):\n"
            "• LOGIC1 (1.0x): 100 × 1.0 = 100 pips\n"
            "• LOGIC2 (1.5x): 100 × 1.5 = 150 pips\n"
            "• LOGIC3 (2.5x): 100 × 2.5 = 250 pips\n\n"
            "<b>Recovery Window:</b>\n"
            "Time to wait before re-entering after SL hunt:\n"
            "• LOGIC1: 30 min (6 × 5m candles)\n"
            "• LOGIC2: 45 min (3 × 15m candles)\n"
            "• LOGIC3: 120 min (2 × 1h candles)"
        )
    else:  # examples
        text = (
            "💡 <b>Examples & Best Practices</b>\n\n"
            ...
            "Settings:\n"
            "• LOGIC1: Lot 1.0x, SL 1.5x\n"
            "• LOGIC2: Lot 0.75x, SL 2.0x\n"
            "• LOGIC3: Lot 0.5x, SL 3.0x\n\n"
            "<b>Example 2: Aggressive Trading</b>\n"
            "Goal: Maximize profits, tight SL\n"
            "Settings:\n"
            "• LOGIC1: Lot 1.5x, SL 0.75x\n"
            "• LOGIC2: Lot 1.25x, SL 1.0x\n"
            "• LOGIC3: Lot 1.0x, SL 1.5x\n\n"
            "<b>Best Practices:</b>\n"
            "✅ Keep LOGIC3 SL higher (2x+)\n"
